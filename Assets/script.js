...
function generatePassword() {
  //this asks how long the password should be
  const passwordLength = prompt(
    "How many characters do you want your password? Please pick a number between 8 and 128."
  );
  //If the number given is between 8 and 128, the following code will continue with questions for the requirements
  if (passwordLength > 7 && passwordLength <= 128) {
    
    //This prompts the user to see if they have certain requirements within the password, if this does then it adds it to the array of possible answers
  ...
  //if the user requested a number of characters outside of the parameters, it will inform the user and not produce a password
    ...
    alert("I'm sorry, please choose a number within our criteria.");
  }
}
